...
<div class="tab-content">
	<div class="tab-pane active" id="general">
		...
		<div class="form-group">
			...
			{!! Form::textarea('site.slogan', option('site.slogan'), ['class' => 'form-control']) !!}
	...
	<div class="tab-pane" id="social">
		...
		<div class="form-group">
			...
			{!! Form::text('youtube.link', option('youtube.link'), ['class' => 'form-control']) !!}
			{!! $errors->first('youtube.link', '<div class="text-danger">:message</div>') !!}
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			{!! Form::label('instagram.link', 'Instagram Link:') !!}
			{!! Form::text('instagram.link', option('instagram.link'), ['class' => 'form-control']) !!}
			{!! $errors->first('instagram.link', '<div class="text-danger">:message</div>') !!}
		</div>				
		<div class="form-group">
			{!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
		</div>
